...
export default function Projects() {
	...
	const projects: Project[] = [
		...
		},
		{
			id: 2,
			title: 'KAS',
			phone: '/mainprojects/phonekas.png',
			phoneSize: { width: 3391, height: 5603 },
			desktop: '/mainprojects/desktopkas.png',
			link: '',
			text: t('kastext'),
			position: 'left',
		},
		{
			...
			phone: '/mainprojects/phonerenaissance.png',
			phoneSize: { width: 6400, height: 4800 },
			desktop: '/mainprojects/renaissancelaptop.png',
			link: '',
			text: t('renaissancetext'),
			position: 'right',
		},
	]
